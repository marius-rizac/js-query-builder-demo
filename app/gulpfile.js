...
var config = {
    sources: {
        css: {
            external: {
                files: [
                    npmSrc + 'jQuery-QueryBuilder/dist/css/query-builder.default.css'
                ]
            },
            internal: {
        ...
        js: {
            external: [
                ...
                npmSrc + 'sql-parser/browser/sql-parser.js',
                npmSrc + 'jQuery-QueryBuilder/dist/js/query-builder.standalone.js'
            ],
            internal: {
